...
export const algoMap = {
	...
	AVL: ['AVL', algos.AVL],
	RedBlackTree: ['Red-Black Tree', algos.RedBlackTree, true],
	BTree: ['2-4 Tree', algos.BTree],
	BubbleSort: ['Bubble Sort', algos.BubbleSort, true],
	CocktailSort: ['Bidirectional Bubble Sort', algos.CocktailSort, true],
	...
	TreeMap: ['Sorted Map (Tree-Backed)', algos.TreeMap]
};
...
export const relatedSearches = {
	...
	BST: ['AVL', 'RedBlackTree', 'Heap', 'SplayTree', 'SkipList', 'BTree'],
	Heap: ['BST', 'AVL', 'SplayTree', 'BTree', 'HeapSort'],
	SkipList: ['BST', 'AVL', 'BTree'],
	OpenHash: ['ClosedHash'],
	ClosedHash: ['OpenHash'],
	SplayTree: ['BST', 'AVL', 'RedBlackTree', 'Heap'],
	AVL: ['BST', 'Heap', 'SplayTree', 'RedBlackTree'],
	RedBlackTree: ['BST', 'AVL', 'BTree', 'SplayTree'],
