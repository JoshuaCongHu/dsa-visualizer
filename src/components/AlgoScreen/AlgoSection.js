...
import { BsClock, BsCodeSlash, BsInfoCircle, BsTranslate } from 'react-icons/bs';
...
const AlgoSection = () => {
	...
	const hasSidebar = !!(infoModals[algoName] || pseudocodeData || complexities);
	...
	return (
		<div id="mainContent">
			...
			<div className={`viewport${hasSidebar ? '' : ' no-sidebar'}`}>
				<canvas id="canvas" ref={canvasRef}></canvas>

				{hasSidebar && (
					<div className="algo-sidebar dark-theme">
